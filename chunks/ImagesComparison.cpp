...
void ImagesComparison::buildGraph(std::vector<Image*> &images, Graph *graph)
{
...
void ImagesComparison::getSimilarImages(std::vector<Image*> &images, std::vector<std::vector<int> > &similar_images)
{
